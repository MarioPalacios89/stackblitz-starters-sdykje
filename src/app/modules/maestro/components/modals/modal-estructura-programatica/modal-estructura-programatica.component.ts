...
@Component({
    selector: 'modal-estructura-programatica',
    templateUrl: './modal-estructura-programatica.component.html',
    styleUrls: ['./modal-estructura-programatica.component.scss'],
    encapsulation: ViewEncapsulation.None,
})
export class ModalEstructuraProgramaticaComponent {
    form: FormGroup;
    ...
    constructor(
        public matDialogRef: MatDialogRef<ModalEstructuraProgramaticaComponent>,
