...
@Component({
  selector: 'modal-gestionar-cronograma-planilla',
  templateUrl: './modal-gestionar-cronograma-planilla.component.html',
  styleUrls: ['./modal-gestionar-cronograma-planilla.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [{ provide: MAT_DATE_FORMATS, useValue: MY_DATE_FORMATS }]
})
export class ModalGestionarCronogramaPlanillaComponent {
...
constructor(
    public matDialogRef:MatDialogRef<ModalGestionarCronogramaPlanillaComponent>,
...
executingUnit:[{value:'',disabled:false}],
