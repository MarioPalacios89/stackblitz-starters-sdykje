...
@Component({
  selector: 'modal-gestionar-cronograma-anual',
  templateUrl: './modal-gestionar-cronograma-anual.component.html',
  styleUrls: ['./modal-gestionar-cronograma-anual.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [{ provide: MAT_DATE_FORMATS, useValue: MY_DATE_FORMATS }]
})
export class ModalGestionarCronogramaAnualComponent {
...
constructor(
    public matDialogRef:MatDialogRef<ModalGestionarCronogramaAnualComponent>,
